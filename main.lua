...
CloudLibraryPlugin.VERSION = "v1.1"
...
1.  添加书籍同步功能，可批量上传或下载云端书籍（v1.0）
2.  添加手势快捷操作，可通过手势调出操作、设置菜单（v1.0）
...
10. 添加在线更新功能（v1.0）
11. 覆盖更新由完全覆盖改为可选覆盖，可以选择是否需要保留本地文档设置（v1.1）

ps：在线更新功能实测安卓端会崩溃，不过新文件仍旧会自动下载到koreader\plugins路径，请找到该路径下的插件压缩包，解压覆盖旧的插件文件即可。
