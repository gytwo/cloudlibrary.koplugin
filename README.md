...
29. Added folder navigation to book download/delete dialog for switching cloud directories(v1.4.4)
...
32. Optimize download/delete dialog refresh logic for better K3/e-ink experience(v1.4.4)
